...
if __name__ == '__main__':
    ...
    Process(target=UpdaterShort, args=(0, queryQ, lock)).start()
    ...
    Process(target=UpdaterShort, args=(1, queryQ, lock)).start()
    while find_window('Open API login') == 0:
        time.sleep(1)
    time.sleep(5)
    manual_login(2)
    ...
    Process(target=UpdaterShort, args=(2, queryQ, lock)).start()
    while find_window('Open API login') == 0:
        time.sleep(1)
    time.sleep(5)
    manual_login(3)
    ...
    Process(target=UpdaterShort, args=(3, queryQ, lock)).start()
    while find_window('Open API login') == 0:
        time.sleep(1)
    time.sleep(5)
    manual_login(4)
